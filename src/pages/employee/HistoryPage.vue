<template>
  <div class="space-y-6">
    <div>
      ...
      <p class="text-muted-foreground text-sm mt-1">Your recent attendance records</p>
    </div>
    ...
    <div v-else-if="attendanceStore.attendanceHistory.length === 0" class="text-center py-12">
    ...
    <div v-else class="space-y-3">
      ...
      >
        <div>
          <p class="text-sm font-medium text-foreground">{{ formatDate(record.clockIn) }}</p>
        ...
        <div class="flex items-center gap-3">
          <span v-if="record.totalHours !== null" class="text-sm text-muted-foreground">
